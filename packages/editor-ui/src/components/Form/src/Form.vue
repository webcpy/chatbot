<script lang="tsx">
import { PropType, defineComponent, ref, computed, unref, watch, onMounted, defineModel } from 'vue'
import {
  ElForm,
  ElFormItem,
  ElRow,
      ...
      const formItemSlots: Recordable = {
        default: () => {
          if (item?.formItemProps?.slots?.default) {
            ...
            let Com: JSX.IntrinsicAttributes | null | undefined = null

            if (isString(item.component)) {
              Com = componentMap[item.component as string] as ReturnType<typeof defineComponent>
            } else {
              Com = item.asyncComponent
            }
            ...
            const slotsMap: Recordable = {
              ...setItemComponentSlots(componentSlots, formModel.value)
            }
